...
ActiveRecord::Schema.define(version: 2022_05_13_194158) do
  ...
  create_table "phoenix_schema_migrations", primary_key: "version", id: :bigint, default: nil, force: :cascade do |t|
